     ...
     if(!isset($_POST['check']))
{
       ...
       $qry = "Select hour1,hour2,hour3,hour4,hour5,hour6 from d_timetable where sem='5' and day='$sel_day'";
}
     else
{
	$qry = "Select hour1,hour2,hour3,hour4,hour5,hour6 from d_timetable where sem='5'";
	$count=0;
}      
       $res = mysql_query($qry);
